...
var fifthStrong = document.createElement('strong');
fifthStrong.innerText = document.querySelectorAll('.disclosure-wrapper > .disclosure.block > div > div')[1].innerText;
  fifthDiv.appendChild(fifthStrong);
