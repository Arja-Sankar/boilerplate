...
//   var urlParams = new URLSearchParams(window.location.search);
    ...
    if(queryPart!=null)
    {
        queryURL=$("#node_Path").val()+".press-release.data?currentItemsCount="+itemsCount+"&ispr="+ispr+"&isevents="+isevents+queryPart+"&industrychange=False"+"&servicechange=False";
    }
    else
    {
        queryURL=$("#node_Path").val()+".press-release.data?currentItemsCount="+itemsCount+"&ispr="+ispr+"&isevents="+isevents+"&industrychange=False"+"&servicechange=False";
    }   
    ...
    for(i=0;i<pageObjs.length;i++)
    {
        ...
        if(pressReleaseItem && pressReleaseItem.length>0){
           ...
           // console.log("imageclass"+imageclass);
            ...
            if(loadMoreAricleImage =="null" || loadMoreAricleImage == "undefined" || watermarkURL!=null){
